...
int main(int argc, char* argv[]) {
  ...
  //~ for (double dd=0.01;dd<=0.05; dd=dd*5){
    //~ d=dd;
    //~ for (int i = 741; i<=1501;i+=10){
      //~ T = i;
      //~ for (double j = 0. ; j<=50. ; j+=1){
        //~ ainit = j;
        //~ Life lilou = Life(T, simul, ainit, width, length, d, pmut, pdeath, wmin, raa, rbb, rab, rbc);
  ...
  //~ for (double dd=0.0005;dd<=0.005; dd=dd*10){
    //~ d=dd;
    //~ for (int i = 741; i<=1501;i+=10){
      //~ T = i;
      //~ for (double j = 0. ; j<=50. ; j+=1){
  ...
  //~ for (double dd=0.000005;dd<=0.00005; dd=dd*10){
    //~ d=dd;
    //~ for (int i = 1; i<=1501;i+=10){
      //~ T = i;
      //~ for (double j = 0. ; j<=50. ; j+=1){
